...
export const metadata: Metadata = {
  title: "Removalists South-West Sydney — VirkTree",
  description: "Professional removalist services across South-West Sydney. VirkTree covers Liverpool, Campbelltown, Ingleburn, Casula, Penrith, St Marys. Fully insured, from $120/hr. Call 0414 866 630.",
};
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[hsl(152,35%,92%)] text-[hsl(152,45%,20%)] text-sm mb-4">
              <MapPin className="w-3 h-3" /> South-West Sydney
            </div>
            <h1 className="text-3xl md:text-4xl font-display font-bold text-[hsl(150,30%,15%)] mb-4">
              Removalists South-West Sydney
            </h1>
            <p className="text-lg text-[hsl(150,10%,45%)] leading-relaxed">
              VirkTree covers all of South-West Sydney from Liverpool to Campbelltown and out to Penrith. We service the entire Macarthur region and outer west corridor.
            </p>
          </div>

          <div className="bg-white rounded-2xl p-6 border border-[hsl(150,15%,88%)] shadow-card mb-8">
            <h2 className="text-xl font-display font-bold text-[hsl(150,30%,15%)] mb-4">Suburbs We Service in South-West Sydney</h2>
            <ul className="grid sm:grid-cols-2 gap-2">
              <li><a href="/removalists-liverpool" className="text-[hsl(152,45%,28%)] hover:underline font-medium">Liverpool Removalists →</a></li>
              <li><a href="/removalists-campbelltown" className="text-[hsl(152,45%,28%)] hover:underline font-medium">Campbelltown Removalists →</a></li>
              <li><a href="/removalists-ingleburn" className="text-[hsl(152,45%,28%)] hover:underline font-medium">Ingleburn Removalists →</a></li>
              <li><a href="/removalists-casula" className="text-[hsl(152,45%,28%)] hover:underline font-medium">Casula Removalists →</a></li>
              <li><a href="/removalists-penrith" className="text-[hsl(152,45%,28%)] hover:underline font-medium">Penrith Removalists →</a></li>
              <li><a href="/removalists-st-marys" className="text-[hsl(152,45%,28%)] hover:underline font-medium">St Marys Removalists →</a></li>
            </ul>
          </div>

          <div className="bg-white rounded-2xl p-6 border border-[hsl(150,15%,88%)] shadow-card mb-8">
            <h2 className="text-xl font-display font-bold text-[hsl(150,30%,15%)] mb-4">Why Choose VirkTree in South-West Sydney?</h2>
            <ul className="space-y-3 text-[hsl(150,10%,45%)]">
              <li className="flex items-start gap-2"><span className="text-[hsl(152,45%,28%)] mt-1">✓</span><span><strong className="text-[hsl(150,30%,15%)]">Local expertise</strong> — we know the streets, parking restrictions, and building access across South-West Sydney</span></li>
          ...
          <div className="bg-gradient-hero rounded-2xl p-8 text-white text-center">
            <h2 className="text-2xl font-display font-bold mb-3">Ready to Move in South-West Sydney?</h2>
